...
class AccountWasDeposited implements Event
{
    private $eventId;
    private $email;
    private $amount;
    ...
    {
        if ($amount <= 0) {
            throw new InvalidArgumentException('THe amount of a deposit must be bigger than zero');
        }
    ...
    public static function unserialize(string $serializedBodyEvent): AccountWasDeposited
    {
